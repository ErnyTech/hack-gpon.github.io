...
TEST 2 Most ONTs run customized firmware which implem vendor and ISP-specific integrations and are locked down in functionality to match service requirements.
